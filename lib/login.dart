...
class LoginPage extends StatelessWidget {
  // Mendefinisikan kelas LoginPage sebagai widget stateless
  final TextEditingController
      usernameController; // Kontrol input untuk username
  final TextEditingController
      passwordController; // Kontrol input untuk password
  final Function login; // Fungsi yang dipanggil ketika login berhasil
  final List<Map<String, String>>
      dataKelompok; // Data kelompok (tidak digunakan di sini)
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      // Membungkus konten dalam SingleChildScrollView untuk memungkinkan pengguliran
      padding: const EdgeInsets.all(
          16.0), // Menambahkan padding di sekeliling konten
      child: Column(
        ...
        children: [
          ...
          Card(
            // Menggunakan Card untuk memberikan efek elevasi
            elevation: 8, // Tingkat elevasi card
            shape: RoundedRectangleBorder(
              // Membentuk sudut card
            ...
            child: Padding(
              ...
              child: Column(
                // Menggunakan Column untuk menyusun widget di dalam card
                ...
                children: [
                  ...
                  SizedBox(
                      height: 20), // Menambahkan ruang kosong di bawah judul
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: Icon(Icons.person,
                          color: Colors.black), // Ikon di depan input
                      labelStyle: TextStyle(color: Colors.black), // Gaya label
                    ),
                  ),
                  SizedBox(
                      height: 10), // Menambahkan ruang kosong di bawah username
                  TextField(
                  ...
                  SizedBox(
                      height: 20), // Menambahkan ruang kosong di bawah password
                  ElevatedButton(
                    // Tombol login
                    onPressed: () {
                      ...
                      if (usernameController.text == 'admin' &&
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                              content: Text(
                                  'Username atau password salah')), // Pesan kesalahan
                        );
                      }
                    },
                    ...
                    style: ElevatedButton.styleFrom(
                      minimumSize:
                          Size(double.infinity, 40), // Ukuran minimum tombol
                      backgroundColor:
