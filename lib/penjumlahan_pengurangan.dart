...
class CalculatorPage extends StatelessWidget {
  // Mendefinisikan CalculatorPage sebagai widget stateless
  final TextEditingController
      num1Controller; // Kontrol input untuk angka pertama
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content:
              Text('Hasil: $result'), // Konten dialog yang menampilkan hasil
          actions: [
            TextButton(
  ...
  void calculate(BuildContext context, String operation) {
    final num1 =
        double.tryParse(num1Controller.text); // Mengonversi input menjadi angka
    final num2 =
        double.tryParse(num2Controller.text); // Mengonversi input menjadi angka
    String result; // Variabel untuk menyimpan hasil

    // Melakukan operasi berdasarkan jenis operasi
    if (num1 == null || num2 == null) {
      result =
          'Masukkan angka yang valid!'; // Pesan kesalahan jika input tidak valid
    } else {
      if (operation == '+') {
        result = (num1 + num2).toStringAsFixed(
            0); // Hasil penjumlahan - tanpa ada angka dibelakang koma
      } else if (operation == '-') {
        result = (num1 - num2).toStringAsFixed(0); // Hasil pengurangan
      } else {
        result =
            'Operasi tidak dikenali'; // Pesan untuk operasi yang tidak dikenali
      }
    }
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            TextField(
              // Widget untuk input angka pertama
              ...
              keyboardType:
                  TextInputType.number, // Menentukan tipe keyboard untuk angka
            ),
            SizedBox(height: 16), // Ruang kosong di bawah input angka pertama
            TextField(
              // Widget untuk input angka kedua
            ...
            Row(
              // Menggunakan Row untuk menyusun tombol operasi secara horizontal
              mainAxisAlignment: MainAxisAlignment
                  .spaceAround, // Menyusun tombol dengan ruang di antara
              children: [
                ElevatedButton(
                  // Tombol untuk penjumlahan
                  onPressed: () => calculate(context,
                      '+'), // Panggil fungsi calculate untuk penjumlahan
                  child: Text('+'), // Teks tombol
                  style: ElevatedButton.styleFrom(
                    backgroundColor:
                        Colors.blueGrey[900], // Warna latar belakang tombol
                ...
                ElevatedButton(
                  ...
                  onPressed: () => calculate(context,
                      '-'), // Panggil fungsi calculate untuk pengurangan
                  child: Text('-'), // Teks tombol
                  style: ElevatedButton.styleFrom(
                    backgroundColor:
                        Colors.blueGrey[900], // Warna latar belakang tombol
