...
class DataKelompokPage extends StatelessWidget {
  // Mendefinisikan DataKelompokPage sebagai widget stateless
  final List<Map<String, String>> dataKelompok; // Daftar data kelompok

  // Konstruktor untuk inisialisasi dataKelompok
  DataKelompokPage({
    required this.dataKelompok, //ambil data dari atas (daftar kelompok)
  });
          ...
          child: Column(
            ...
            children: [
              ...
              Card(
                ...
                child: SingleChildScrollView(
                  // Membungkus tabel dalam SingleChildScrollView untuk pengguliran horizontal
                  scrollDirection: Axis.horizontal,
                  child: DataTable(
                    // Menggunakan DataTable untuk menampilkan data dalam format tabel
                    columns: [
                      DataColumn(
                        // Kolom untuk NIM
                        label: Center(
                    ...
                    rows: dataKelompok.isNotEmpty
                        ? dataKelompok.map((item) {
                            ...
                            return DataRow(
                              // Membuat DataRow untuk setiap item
                              cells: [
                                DataCell(
                                  // Sel untuk NIM
                                  Align(
                                    alignment: Alignment
                                        .centerLeft, // Mengatur alignment teks
                                    child: Text(item['NIM']!,
                                        style: TextStyle(
                                            color: Colors
                                                .black)), // Menampilkan NIM
                                  ),
                                ),
                                DataCell(
                                  // Sel untuk Nama
                        ...
                        : [
                            ...
                            DataRow(
                              ...
                              cells: [
                                DataCell(
                                    Text('Tidak ada data')), // Sel untuk pesan
