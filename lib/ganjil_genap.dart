...
class OddEvenPage extends StatelessWidget {
  // Mendefinisikan OddEvenPage sebagai widget stateless
  final TextEditingController numberController; // Kontrol input untuk angka

  OddEvenPage(
      {required this.numberController}); // Konstruktor untuk inisialisasi kontroler
  ...
  void checkNumber(BuildContext context) {
    final number = int.tryParse(
        numberController.text); // Mencoba mengonversi input menjadi integer
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: Text('Bilangan Ganjil/Genap')), // Judul aplikasi di AppBar
      body: Container(
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              // Tombol untuk memeriksa angka
              onPressed: () => checkNumber(
                  context), // Panggil fungsi checkNumber saat tombol ditekan
            ...
            ElevatedButton(
              ...
              onPressed: () {
                numberController.clear(); // Menghapus input angka
              },
